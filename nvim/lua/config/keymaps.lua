...
vim.keymap.set(
	...
	"<Leader>tn",
	":tabnew +terminal<CR>",
	{ noremap = true, silent = true, desc = "[T]erminal [O]pen in new tab" }
)
vim.keymap.set(
	"n",
	"<Leader>t_",
	":new +terminal<CR>",
	{ noremap = true, silent = true, desc = "[T]erminal [O]pen below" }
)
vim.keymap.set(
	"n",
	"<Leader>t|",
	":vnew +terminal<CR>",
	{ noremap = true, silent = true, desc = "[T]erminal [O]pen side" }
)
